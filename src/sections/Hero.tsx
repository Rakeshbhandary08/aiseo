...
export const Hero = () => {
  return (
    <section className="flex h-[492px] md:h-[800px]  md:-top-16 items-center overflow-hidden relative [mask-image:linear-gradient(transparent,black_10%,black_90%,transparent)]" style={{ backgroundImage: `url(${starBg.src})` }}>
      ...
      {/* First Ring 3 */}
      <div className="absolute opacity-20 w-[544px] h-[544px] md:w-[980px] md:h-[980px] rounded-full border border-white top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
        <div className="absolute w-2 h-2 bg-white  rounded-full top-1/2 -translate-x-1/2 -translate-y-1/2"></div>
